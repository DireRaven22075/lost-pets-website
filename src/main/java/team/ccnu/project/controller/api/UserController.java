...
public class UserController {
    ...
    /// <summary>
    /// TODO : Service 측 구현 필요. There are 'i', 'u', 'b' as role value. To Do: Update role value as 'b' (only use english)
    /// 회원 탈퇴
    /// </summary>
    @DeleteMapping("/{mem}")
    public ResponseEntity<?> apiDeleteUser(HttpServletRequest request, @PathVariable Long mem) {
        ...
        session.invalidate();
        //TODO : 구현 필요. if intercepter are different in SN each. Redirection
